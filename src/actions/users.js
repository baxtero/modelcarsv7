import {
  ...
  export const createUser = (title, description, fname, lname, email, zip) => async (dispatch) => {
    try {
      const res = await UserDataService.create({ title, description, fname, lname, email, zip });
